(function () {
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyCxTC6ic_Zir_rDcfo4HFd5XU9OnPBeN3E",
    authDomain: "mit-courso-99.firebaseapp.com",
    databaseURL: "https://mit-courso-99-default-rtdb.europe-west1.firebasedatabase.app",
    projectId: "mit-courso-99",
    storageBucket: "mit-courso-99.appspot.com",
    messagingSenderId: "868907885042",
    appId: "1:868907885042:web:c74f75f623be5e85c9cb6b"
  };
  // Initialize Firebase
  ...
  let currentUserEmail = 'lolo@lucy.com'; // variable to store the current user's email
  ...
  // This function triggered on click parses the contents of the messages array to show them in the chat window
  function handleRead() {
    status.innerHTML = '';
    chat.innerHTML = '';
    const messages = db.ref('messages');
